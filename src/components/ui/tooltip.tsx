...
/**
 * Família de componentes UI para criação de Dicas de Interface (Tooltips).
 * Construída sobre os primitivos do Base UI, inclui suporte a Provedores de delay global,
 * posicionamento inteligente do popup em relação ao elemento pai e indicador visual em seta.
 */
